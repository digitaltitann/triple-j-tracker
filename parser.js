...
const PropParser = {
    ...
    nbaTeams: {
        ...
        'cle cavaliers': { abbrev: 'CLE', name: 'Cavaliers' },
        ...
        'gs warriors': { abbrev: 'GSW', name: 'Warriors' },
        ...
        'ny knicks': { abbrev: 'NYK', name: 'Knicks' },
        ...
        'sa spurs': { abbrev: 'SAS', name: 'Spurs' },
